...
if(!empty($_POST['action']) && $_POST['action'] == 'edit'  && $_POST['message_id'] != '' && $_POST['txtmessage'] != '' && $_POST['prev_value'] != '') {
    ...
    $insert_row = $mysqli->query("INSERT INTO logs set log_chem_id = '" . $chem_id . "' , log_new_value = '" . $new_value . "' , log_prev_value= '" . ($prev_value) . "',  log_added_user_id = '" . $_SESSION["uid"] . "', log_added_date = '" . date("Y-m-d H:i:s") . "', log_type = '1',  log_ip_address = '" . $_SERVER['REMOTE_ADDR'] . "' ");
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            if ($_POST['submit'] == 'Filter') {
                                ...
                                $results = $mysqli->query(" select z.* from  ( select a.*,b.name ,c.dept_short_name,c.dept_name,d.log_new_value from chemicals as a 
                                                        ...
                                                        where   a.chem_id > 0  $cond   order by d.log_id desc) as z group by z.chem_id  ");
